...
Simple docker container to act as local caching proxy for a munki repo.  This includes mDNS advertising as a _munki._tcp. service.  This must use the host networking adapter to work properly `--net=host`
...
AVAHI_HOST | munki-proxy | mDNS hostname for proxy host.  Defaults to munki-proxy.
